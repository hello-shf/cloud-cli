 ...
 * @Version V1.0
 **/
public class PrexCustomWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
    ...
    private ResponseEntity<OAuth2Exception> handleOAuth2Exception(OAuth2Exception e) {
        ...
        PrexCustomOauthException exception = new PrexCustomOauthException(e.getMessage(), e.getOAuth2ErrorCode());
